...
public class TaskController {
	...
	// --------------------------------------------------------------
	@GetMapping("/search")
	public ResponseEntity<?> search(@RequestParam Long organizationId, @RequestParam(required = false) String keyword,
			Pageable pageable) {
	...
	public ResponseEntity<?> addDependency(@PathVariable Long taskId, @RequestParam Long dependsOnTaskId,
	...
	public ResponseEntity<?> removeDependency(@PathVariable Long taskId, @RequestParam Long dependsOnTaskId) {
	...
	// --------------------------------------------------------------
	@GetMapping("/my-tasks")
	public ResponseEntity<?> getMyTasks(@RequestParam Long userId, @RequestParam(required = false) String status,
			@RequestParam(required = false) String priority, @RequestParam(required = false) Long projectId) {
		Long organizationId=securityContextUtil.getCurrentOrganizationId();
		List<TaskDTO> tasks = taskService.getMyTasks(organizationId);
		return helper.success("My tasks fetched successfully", tasks);
	}
	...
	public ResponseEntity<?> getTaskStatistics(@RequestParam Long userId) {
		return helper.success("Task statistics fetched successfully", Map.of());
	}
	...
	public ResponseEntity<?> bulkUpdate(@RequestBody BulkUpdateRequest request) {
		return helper.success("Tasks updated successfully", List.of());
	}
	...
	public ResponseEntity<?> quickUpdate(@PathVariable Long id, @RequestParam String field,
