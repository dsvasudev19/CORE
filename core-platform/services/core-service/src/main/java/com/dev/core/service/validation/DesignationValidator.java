...
public class DesignationValidator {
    ...
    public void validateBeforeCreate(DesignationDTO dto) {
        if (dto == null)
            throw new ValidationFailedException("error.designation.null",null);

        if (dto.getTitle() == null || dto.getTitle().isBlank())
            throw new ValidationFailedException("error.designation.title.required",null);
    ...
    public void validateBeforeUpdate(Long id, DesignationDTO dto) {
        if (id == null)
            throw new ValidationFailedException("error.designation.id.required",null);
