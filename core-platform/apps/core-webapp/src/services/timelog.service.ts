...
export const timelogService = {
  ...
  getWeeklyBreakdown: async (
    userId: number,
    weekStart: string,
  ): Promise<TimeBreakdown[]> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/weekly/breakdown`,
      {
        params: { userId, weekStart },
      },
    );
  ...
  getMonthlyBreakdown: async (
    ...
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/monthly/breakdown`,
      {
        params: { userId, year, month },
      },
    );
  ...
  getTotalTimeForProject: async (
    userId: number,
    projectId: number,
  ): Promise<number> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/project/total`,
      {
  ...
  getCompanyDailyTotal: async (date: string): Promise<number> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/company/daily-total`,
      {
        params: { date },
      },
    );
  ...
  getCompanyWeeklyTotal: async (weekStart: string): Promise<number> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/company/weekly-total`,
      {
        params: { weekStart },
      },
    );
  ...
  getCompanyMonthlyTotal: async (
    year: number,
    month: number,
  ): Promise<number> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/company/monthly-total`,
      {
        params: { year, month },
      },
    );
  ...
  getCompanyDailyBreakdown: async (date: string): Promise<any> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/company/daily-breakdown`,
      {
        params: { date },
      },
    );
  ...
  getUserProjectBreakdown: async (
    ...
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/user/project-breakdown`,
      {
  ...
  getCompanyProjectBreakdown: async (
    fromDate: string,
    toDate: string,
  ): Promise<ProjectBreakdown[]> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/company/project-breakdown`,
      {
  ...
  // --------------------------------------------------------------
  getTimeLogsWithSubordinates: async (
    userId: number,
    projectId?: number,
    taskId?: number,
    bugId?: number,
    ...
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/with-subordinates`,
      {
        params: { userId, projectId, taskId, bugId, fromDate, toDate },
      },
    );
  ...
  getDailyLogsWithSubordinates: async (
    userId: number,
    date: string,
  ): Promise<TimeLogDTO[]> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/daily/with-subordinates`,
      {
        params: { userId, date },
      },
    );
  ...
  getWeeklyLogsWithSubordinates: async (
    userId: number,
    weekStart: string,
  ): Promise<TimeLogDTO[]> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/weekly/with-subordinates`,
      {
        params: { userId, weekStart },
      },
    );
  ...
  getMonthlyLogsWithSubordinates: async (
    userId: number,
    year: number,
    month: number,
  ): Promise<TimeLogDTO[]> => {
    const response = await axiosInstance.get(
      `${TIMELOG_API_BASE}/monthly/with-subordinates`,
      {
        params: { userId, year, month },
      },
    );
