...
public class SystemSeederService {
    ...
    private static final List<String> RESOURCES = Arrays.asList(
            ...
            "PROJECTDOCUMENT", "AUDITLOG", "REFRESHTOKEN", "TIMESHEET", "REPORT","TASKDEPENDENCY","CLIENT_DOCUMENT","PROJECTPHASE","PROJECT_MEMBER","TASKCOMMENT","TASKTAGS","TASK_TAGS","TASKATTACHMENT"
    );
